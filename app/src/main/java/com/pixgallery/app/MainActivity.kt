...
private fun GalleryContent(
    ...
    // in RewardedAdManager). Set useTestAd = false only right before
    // publishing, once you've swapped in your real ad unit ID.
    val rewardedAdManager = remember {
        RewardedAdManager(context, useTestAd = true, everyNActions = 3)
    }
